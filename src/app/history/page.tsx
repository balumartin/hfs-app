const timelineData = [
  {
    year: "2003",
    title: "A szómaesztétika első magyar nyelvű megjelenése",
    description:
  ...
  {
    year: "2012",
    title: "Krémer Sándor találkozása Shustermannel",
    description:
  ...
  {
    year: "2014",
    title: "Első magyarországi szómaesztétikai konferencia",
    description:
  ...
  {
    year: "2017",
    title: "Győri szimpózium és szegedi konferencia",
    description:
  ...
  {
    year: "2018",
    title: "Újabb szegedi konferencia, Fórum alapítása",
    description:
  ...
  {
    year: "2019",
    title: "Designkultúra és szómaesztétika konferencia",
    description:
  ...
  {
    year: "2022",
    title: "30 éves jubileumi konferencia",
    description:
  ...
  {
    year: "2025",
    title: "Atmospheres and Architectonics konferencia",
    description:
  ...
  {
    year: "2023",
    title: "Könyv: 'Somaesthetics and Design Culture'",
    description:
  ...
  {
    year: "2014–2015",
    title: "Fordítások: 'Thinking Through the Body'",
    description:
  ...
  {
    year: "2024",
    title: "Shusterman díszdoktor a MOME-n",
    description:
  ...
  {
    year: "2025",
    title: "Szómaesztétika magyarországi recepciójában",
    description:
...
export default function page() {
  return (
    <section className="mx-container p-container bg-white font-akzidenz lg:rounded-xl shadow-xl lg:mb-10">
      <div className="relative w-[90%] border-l-2 border-blue-200 dark:border-gray-600 ml-4 pl-4 my-8">
        {timelineData.map((data, idx) => (
          <div key={idx} className="mb-10 ml-4">
            <div className="absolute -left-2 w-4 h-4 bg-secondary rounded-full border-2 border-blue-500 dark:border-gray-900"></div>
            <time className="text-lg flex items-start leading-none  text-gray-500 dark:text-gray-400">
              {data.year}
            </time>
